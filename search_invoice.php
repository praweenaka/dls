...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" href="css/bootstrap.min.css">
            ...
            <script language="JavaScript" src="js1/invoice.js"></script>
    ...
    <body>
        ...
        <div id="filt_table" class="CSSTableGenerator">  <table width="735"   class="table table-bordered">
                ...
                <?php
                $sql = "SELECT * from invoice   order by id desc limit 50";
                ...
                foreach ($conn->query($sql) as $row) {
                    ...
                    echo "<tr>               
                              <td onclick=\"custno('" . $row['invoiceno'] . "','" . $row['fname'] . "','" . $row['nic'] . "', '$stname');\">" . $row['invoiceno'] . "</a></td>
                              <td onclick=\"custno('" . $row['invoiceno'] . "','" . $row['fname'] . "','" . $row['nic'] . "', '$stname');\">" . $row['fname'] . "</a></td>
                              <td onclick=\"custno('" . $row['invoiceno'] . "','" . $row['fname'] . "','" . $row['nic'] . "', '$stname');\">" . $row['nic'] . "</a></td>

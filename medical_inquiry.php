...
<section class="content">
 ...
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>gamca_no</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='gamca_no'  id='gamca_no' class='form-control Name  input-sm'>
 </div>
 </div>
 ...
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>e_no</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='e_no'  id='e_no' class='form-control Name  input-sm'>
 </div>
 </div>
 
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>sub_name</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='sub_name'  id='sub_name' class='form-control Name  input-sm'>
 </div>
 </div>
 ...
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>job</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='job'  id='job' class='form-control Name  input-sm'>
 </div>
 </div>
 ...
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>xray_no</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='xray_no'  id='xray_no' class='form-control Name  input-sm'>
 </div>
 </div>
 
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>cust_remarks</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='cust_remarks'  id='cust_remarks' class='form-control Name  input-sm'>
 </div>
 </div>
 ...
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>family_planning</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='family_planning'  id='family_planning' class='form-control Name  input-sm'>
 </div>
 </div>
 ...
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>res</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='res'  id='res' class='form-control Name  input-sm'>
 </div>
 </div>
 
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>last_child_age</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='last_child_age'  id='last_child_age' class='form-control Name  input-sm'>
 </div>
 </div>
 
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>childrens</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='childrens'  id='childrens' class='form-control Name  input-sm'>
 </div>
 </div>
 
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>married</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='married'  id='married' class='form-control Name  input-sm'>
 </div>
 </div>
 
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>lrmp</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='lrmp'  id='lrmp' class='form-control Name  input-sm'>
 </div>
 </div>
 
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>bp</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='bp'  id='bp' class='form-control Name  input-sm'>
 </div>
 </div>
 
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>cre</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='cre'  id='cre' class='form-control Name  input-sm'>
 </div>
 </div>
 
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>dr_remarks</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='dr_remarks'  id='dr_remarks' class='form-control Name  input-sm'>
 </div>
 </div>
 
 <div class='form-group'></div>
 <div class='form-group-sm'>
 <label class='col-sm-2' for='c_code'>lab_remarks
</label>
 <div class='col-sm-2'>
 <input type='text' placeholder='lab_remarks'  id='lab_remarks' class='form-control Name  input-sm'>
 </div>
 </div>
